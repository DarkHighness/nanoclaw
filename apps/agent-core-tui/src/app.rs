...
mod tests {
    ...
    use agent_core::skills::Skill;
    use agent_core_runtime::{ToolApprovalOutcome, ToolApprovalRequest};
    use agent_core_store::RunSummary;
    use agent_core_types::{RunId, ToolCall, ToolCallId, ToolOrigin, ToolOutputMode, ToolSpec};
    use serde_json::json;
    use std::collections::BTreeMap;
