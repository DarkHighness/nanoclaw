...
use crate::ui::{
    ...
    LoadedMcpPrompt, LoadedMcpResource, LoadedSession, LoadedTask, ManagedMcpServerSummary,
    ManagedPluginSummary, ManagedSkillSummary, McpPromptSummary, McpResourceSummary,
...
use history::{
    ...
    format_mcp_resource_summary_line, format_session_export_result, format_session_inspector,
