...
#[cfg(feature = "browser-tools")]
use agent::{
    BrowserClickTool, BrowserCloseTool, BrowserEvalTool, BrowserOpenTool, BrowserScreenshotTool,
    BrowserSnapshotTool, BrowserTypeTool,
};
use agent::{
    CheckpointListTool, CheckpointRestoreTool, CheckpointSummarizeTool, CodeDiagnosticsTool,
    CodeDocumentSymbolsTool, CodeIntelBackend, CodeNavTool, CodeSearchTool, CodeSymbolSearchTool,
...
pub fn register_browser_tools(tools: &mut ToolRegistry, browser_manager: Arc<dyn BrowserManager>) {
    ...
    tools.register(BrowserScreenshotTool::new(browser_manager.clone()));
