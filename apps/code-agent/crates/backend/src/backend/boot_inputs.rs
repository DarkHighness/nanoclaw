...
pub struct DriverHostInputs {
    pub runtime_hooks: Vec<HookRegistration>,
    pub mcp_servers: Vec<McpServerConfig>,
    pub instructions: Vec<String>,
}

pub fn merge_driver_host_inputs(
...
pub fn dedup_mcp_servers(servers: Vec<McpServerConfig>) -> Vec<McpServerConfig> {
...
pub fn driver_host_output_lines(driver_outcome: &DriverActivationOutcome) -> Vec<String> {
    driver_outcome
        .host_messages()
