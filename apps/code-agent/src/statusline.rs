...
pub(crate) enum StatusLineField {
    Status,
    Model,
    Cwd,
    Repo,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(crate) struct StatusLineFieldSpec {
    pub(crate) field: StatusLineField,
...
impl StatusLineConfig {
    pub(crate) fn enabled(&self, field: StatusLineField) -> bool {
        match field {
    ...
    pub(crate) fn set_enabled(&mut self, field: StatusLineField, enabled: bool) {
        match field {
    ...
    pub(crate) fn toggle(&mut self, field: StatusLineField) -> bool {
...
pub(crate) fn status_line_fields() -> &'static [StatusLineFieldSpec] {
    STATUS_LINE_FIELDS
}
