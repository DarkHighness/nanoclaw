...
pub(crate) const SESSION_MEMORY_WAIT_TIMEOUT_MS: u64 = 15_000;
pub(crate) const SESSION_MEMORY_STALE_THRESHOLD_MS: u64 = 60_000;
const SESSION_MEMORY_WAIT_POLL_MS: u64 = 250;

#[derive(Clone, Debug, Default)]
pub(crate) struct SessionMemoryRefreshState {
    ...
    pub(crate) tokens_at_last_update: usize,
    pub(crate) tool_calls_since_update: usize,
    pub(crate) last_summarized_message_id: Option<MessageId>,
}

pub(crate) type SharedSessionMemoryRefreshState = Arc<Mutex<SessionMemoryRefreshState>>;

pub(crate) fn session_memory_note_absolute_path(
    workspace_root: &Path,
...
pub(crate) struct SessionMemoryConversationCompactor {
