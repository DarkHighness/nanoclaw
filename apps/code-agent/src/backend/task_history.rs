...
pub(crate) struct PersistedTaskSummary {
    pub(crate) task_id: String,
    pub(crate) session_ref: String,
    pub(crate) parent_agent_session_ref: String,
    pub(crate) child_session_ref: Option<String>,
    pub(crate) child_agent_session_ref: Option<String>,
...
pub(crate) struct LoadedTask {
    pub(crate) summary: PersistedTaskSummary,
    pub(crate) spec: AgentTaskSpec,
    pub(crate) child_transcript: Vec<Message>,
    pub(crate) result: Option<AgentResultEnvelope>,
    pub(crate) error: Option<String>,
    pub(crate) artifacts: Vec<AgentArtifact>,
    pub(crate) messages: Vec<LoadedTaskMessage>,
