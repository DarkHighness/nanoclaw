...
/// of built-in read-only research tools and configured simple exec prefixes
/// instead of trusting arbitrary `read_only` metadata from MCP or custom tools.
/// The policy also checks the
