...
use agent_core::{AgentRuntime, RuntimeCommand, RuntimeCommandQueue, Skill};
use anyhow::Result;
    ...
    fn handle_approval_key(&mut self, key: KeyEvent) -> bool {
        ...
        let outcome = match key.code {
            KeyCode::Char('y') | KeyCode::Char('Y') => {
                Some(agent_core::runtime::ToolApprovalOutcome::Approve)
            }
            KeyCode::Char('n') | KeyCode::Char('N') | KeyCode::Esc => {
                Some(agent_core::runtime::ToolApprovalOutcome::Deny {
        ...
        if let Some(outcome) = outcome {
            let approved = matches!(outcome, agent_core::runtime::ToolApprovalOutcome::Approve);
